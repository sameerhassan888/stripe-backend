...
const getLoggedInAdmin = async (req, res) => {
  try {
    // Assuming you have a middleware that verifies the user's authentication and sets req.user
    ...
    // Send the admin's information to the frontend
    res.status(200).json({ success: true, admin: loggedInAdmin });
  } catch (error) {
    console.error(error);
...
// Export your other functions and the new getLoggedInAdmin function
module.exports = {
  register,
  login,
  getLoggedInAdmin, // Add this line
};